...
description: The verbatim OKF v0.1 draft specification — the normative source of truth for every OKF bundle in this repository.
tags: [okf, convention, specification]
...
<!--
  ...
  This is the canonical normative reference. See the [authoring guide](./authoring-guide.md)
  for how to apply it and [validation](./validation.md) for how to check conformance.
-->
